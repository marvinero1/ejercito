...
<div class="container-xxl py-5">
                ...
                <div class="bs-stepper-content"><br>
                    <div id="test-l-1" class="content">
                        <div class="col-6 col-sm-6">
                            ...
                            <span><strong>Ingrese su codigo de Verificación</strong></span>
                            <br>
    ...
    <script>
        function buscarCodigo() {
            ...
            let codigo_mayusculas = codigo_input.toUpperCase();
            console.log(codigo_mayusculas);

            const resultado = array1.find((element) => element.code === codigo_mayusculas);
            if (resultado) {
                stepper1.next();
            } else {
