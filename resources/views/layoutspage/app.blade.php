...
<!-- Booking Start -->
<div class="container-fluid bg-secondary my-5 wow fadeInUp" data-wow-delay="0.1s" style="background-image:url(images/img/form-1.jpg); ">
    <div class="container">
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                <div class="h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <a class="btn btn-secondary w-100 py-3" type="button" href="/postulante"><i class="fa fa-book"></i> Postulate</a>
                </div>
            </div>
        </div>
    </div>
