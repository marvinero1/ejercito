 ...
 <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="images/img/portada/background-bg-1.jpg" alt="portada">
            <div class="carousel-caption d-flex align-items-center">
                <div class="container">
                    <div class="row align-items-center justify-content-center justify-content-lg-start">
                        <div class="col-12 col-lg-12 text-center text-center">
                            <p class="display-3 text-white  animated slideInDown1">FORMAMOS SARGENTOS PARA EL FUTURO DE BOLIVIA</p>
                            <hr>
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-flex align-items-center">
                <div class="container">
                    <div class="row align-items-center justify-content-center justify-content-lg-start">
                        <div class="col-12 col-lg-12 text-center text-center">
                            <p class="display-3 text-white  animated slideInDown1">CUANDO EL CLARIN DE LA PATRIA LLAMA, HASTA EL LLANTO DE LAS MADRES CALLA</p>
                            <hr>
                            <h1 class="display-3 text-white  animated slideInDown"><strong>E.M.S.E.</strong></h1>
                            {{-- <a href="" class="btn btn-primary py-3 px-5 animated slideInDown"><i class="fa fa-arrow-right ms-3"></i></a> --}}
                        </div>
